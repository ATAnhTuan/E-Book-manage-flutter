...
abstract class AppStoreBase with Store {
  ...
  Future<void> setDarkMode(bool aIsDarkMode) async {
    ...
    if (isDarkModeOn) {
      ...
      defaultLoaderBgColorGlobal = cardBackgroundBlackDark;

      setStatusBarColor(appBackgroundColorDark, statusBarIconBrightness: Brightness.light, statusBarBrightness: Brightness.light);
    } else {
      textPrimaryColorGlobal = textPrimaryColor!;
      textSecondaryColorGlobal = textSecondaryColor!;
      shadowColorGlobal = Colors.black12;
      defaultLoaderBgColorGlobal = white;
  ...
  Future<void> toggleDarkMode({bool? value}) async {
    ...
    if (isDarkModeOn) {
      ...
      scaffoldBackground = white_color;
